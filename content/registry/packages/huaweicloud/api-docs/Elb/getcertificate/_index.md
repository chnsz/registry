...
title_tag: "huaweicloud.Elb.getCertificate"
meta_desc: "Documentation for the huaweicloud.Elb.getCertificate function with examples, input properties, output properties, and supporting types."
layout: api
...
return await Deployment.RunAsync(() => 
{
    ...
    var test = Huaweicloud.Elb.GetCertificate.Invoke(new()
    {
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var test = ElbFunctions.getCertificate(GetCertificateArgs.builder()
            .name(certificateName)
            .type("server")
            .build());
...
variables:
  test:
    Fn::Invoke:
      Function: huaweicloud:Elb:getCertificate
      Arguments:
        name: ${certificateName}
        type: server
```
...
<span class="k">&nbsp;&nbsp;Function:</span> huaweicloud:Elb/getCertificate:getCertificate
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>The region in which to obtain the ELB certificate. If omitted, the provider-level region
will be used.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>Specifies the certificate type. The default value is <code>server</code>. The value can be one of the
following:</p>
<ul>
