...
---
title: "Group"
title_tag: "huaweicloud.SharedApig.Group"
meta_desc: "Documentation for the huaweicloud.SharedApig.Group resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
{
    var apigwGroup = new Huaweicloud.SharedApig.Group("apigwGroup", new()
    {
...
public class App {
    ...
    public static void stack(Context ctx) {
        var apigwGroup = new Group("apigwGroup", GroupArgs.builder()        
            .description("your descpiption")
            .build());
...
apigw_group = huaweicloud.shared_apig.Group("apigwGroup", description="your descpiption")
```
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">huaweicloud:SharedApig:Group</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd><p>Specifies the description of the API group. The description cannot exceed 255
characters.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Specifies the name of the API group. An API group name consists of 3–64 characters,
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>The region in which to create the API gateway group resource. If omitted, the
provider-level region will be used. Changing this creates a new gateway group resource.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd><p>Status of the API group.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">) -&gt;</span> Group</code></pre></div>
</pulumi-choosable>
</div>
