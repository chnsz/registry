...
---
title: "InfluxInstance"
title_tag: "huaweicloud.GaussDBforNoSQL.InfluxInstance"
meta_desc: "Documentation for the huaweicloud.GaussDBforNoSQL.InfluxInstance resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
{
    var instance1 = new Huaweicloud.GaussDBforNoSQL.InfluxInstance("instance1", new()
    {
...
import com.pulumi.huaweicloud.GaussDBforNoSQL.InfluxInstance;
import com.pulumi.huaweicloud.GaussDBforNoSQL.InfluxInstanceArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        var instance1 = new InfluxInstance("instance1", InfluxInstanceArgs.builder()        
...
resources:
  instance1:
    type: huaweicloud:GaussDBforNoSQL:InfluxInstance
    properties:
      password: ${var.password}
      flavor: geminidb.influxdb.large.4
      volumeSize: 100
...
return await Deployment.RunAsync(() => 
{
    var instance1 = new Huaweicloud.GaussDBforNoSQL.InfluxInstance("instance1", new()
    {
        ...
        SecurityGroupId = @var.Secgroup_id,
        AvailabilityZone = @var.Availability_zone,
        BackupStrategy = new Huaweicloud.GaussDBforNoSQL.Inputs.InfluxInstanceBackupStrategyArgs
        {
...
import com.pulumi.huaweicloud.GaussDBforNoSQL.InfluxInstance;
import com.pulumi.huaweicloud.GaussDBforNoSQL.InfluxInstanceArgs;
import com.pulumi.huaweicloud.GaussDBforNoSQL.inputs.InfluxInstanceBackupStrategyArgs;
import java.util.List;
import java.util.ArrayList;
import java.util.Map;
import java.io.File;
...
public class App {
    ...
    public static void stack(Context ctx) {
        var instance1 = new InfluxInstance("instance1", InfluxInstanceArgs.builder()        
            ...
            .securityGroupId(var_.secgroup_id())
            .availabilityZone(var_.availability_zone())
            .backupStrategy(InfluxInstanceBackupStrategyArgs.builder()
                .startTime("03:00-04:00")
                .keepDays(14)
                .build())
            .build());
...
## Create InfluxInstance Resource {#create}
<div>
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">InfluxInstance</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">InfluxInstanceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nx">InfluxInstance</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">backup_strategy</span><span class="p">:</span> <span class="nx">Optional[_gaussdbfornosql.InfluxInstanceBackupStrategyArgs]</span> = None<span class="p">,</span>
                   ...
                   <span class="nx">datastore</span><span class="p">:</span> <span class="nx">Optional[_gaussdbfornosql.InfluxInstanceDatastoreArgs]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">InfluxInstance</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">InfluxInstanceArgs</a></span><span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewInfluxInstance</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">InfluxInstanceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">InfluxInstance</span>, error)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">InfluxInstance</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">InfluxInstanceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">InfluxInstance</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">InfluxInstanceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">InfluxInstance</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">InfluxInstanceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">huaweicloud:GaussDBforNoSQL:InfluxInstance</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">InfluxInstanceArgs</a></span>
    </dt>
...
## InfluxInstance Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs](/docs/intro/concepts/inputs-outputs) in the Architecture and Concepts docs.

### Inputs

The InfluxInstance resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
see <a href="https://support.huaweicloud.com/intl/en-us/influxug-nosql/nosql_05_0045.html">DB Instance Specifications</a>
...
GaussDB influx instance, the minimum storage space is <strong>100</strong> GB, and the maximum storage space is related to the
instance performance specifications. For details,
see <a href="https://support.huaweicloud.com/intl/en-us/influxug-nosql/nosql_05_0045.html">DB Instance Specifications</a></p>
</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#backupstrategy_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Strategy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancebackupstrategy">Influx<wbr>Instance<wbr>Backup<wbr>Strategy<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_csharp" style="color: inherit; text-decoration: inherit;">Datastore</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancedatastore">Influx<wbr>Instance<wbr>Datastore<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodenum_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Num</a>
    ...
    <dd><p>Specifies the number of nodes, ranges from <strong>3</strong> to <strong>16</strong>. Defaults to <strong>3</strong>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
If <code>period_unit</code> is set to <strong>month</strong> , the value ranges from <strong>1</strong> to <strong>9</strong>. If <code>period_unit</code> is set to <em>year</em>, the
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>The region in which to create the influx instance resource. If omitted, the
provider-level region will be used. Changing this creates a new influx instance resource.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#backupstrategy_yaml" style="color: inherit; text-decoration: inherit;">backup<wbr>Strategy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancebackupstrategy">Property Map</a></span>
    </dt>
    <dd><p>Specifies the advanced backup policy. Structure is documented below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_yaml" style="color: inherit; text-decoration: inherit;">datastore</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancedatastore">Property Map</a></span>
    </dt>
    <dd><p>Specifies the database information. Structure is documented below. Changing
this parameter will create a new resource.</p>
</dd><dt class="property-optional property-replacement"
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the InfluxInstance resource produces the following output properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodes_csharp" style="color: inherit; text-decoration: inherit;">Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancenode">List&lt;Influx<wbr>Instance<wbr>Node&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodes_go" style="color: inherit; text-decoration: inherit;">Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancenode">[]Influx<wbr>Instance<wbr>Node</a></span>
    </dt>
    <dd><p>Indicates the instance nodes information. Structure is documented below.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodes_yaml" style="color: inherit; text-decoration: inherit;">nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancenode">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>Indicates the instance nodes information. Structure is documented below.</p>
</dd><dt class="property-"
            title="">
...
## Look up Existing InfluxInstance Resource {#look-up}

Get an existing InfluxInstance resource's state with the given name, ID, and optional extra properties used to qualify the lookup.
<div>
<pulumi-chooser type="language" options="typescript,python,go,csharp,java,yaml"></pulumi-chooser>
</div>
...
<div>
<pulumi-choosable type="language" values="javascript,typescript">
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">public static </span><span class="nf">get</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#ID">Input&lt;ID&gt;</a></span><span class="p">,</span> <span class="nx">state</span><span class="p">?:</span> <span class="nx">InfluxInstanceState</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">): </span><span class="nx">InfluxInstance</span></code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">node_num</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">nodes</span><span class="p">:</span> <span class="nx">Optional[Sequence[_gaussdbfornosql.InfluxInstanceNodeArgs]]</span> = None<span class="p">,</span>
        <span class="nx">password</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">period</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">period_unit</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        ...
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">,</span>
        <span class="nx">volume_size</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">vpc_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> InfluxInstance</code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetInfluxInstance<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">InfluxInstanceState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">InfluxInstance</span>, error)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span><span class="nx">InfluxInstance</span><span class="nf"> Get</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.Input-1.html">Input&lt;string&gt;</a></span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">InfluxInstanceState</span><span class="p">? </span><span class="nx">state<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="java">
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">InfluxInstance</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">InfluxInstanceState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodes_csharp" style="color: inherit; text-decoration: inherit;">Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancenode">List&lt;Influx<wbr>Instance<wbr>Node<wbr>Args&gt;</a></span>
    </dt>
    <dd><p>Indicates the instance nodes information. Structure is documented below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodes_go" style="color: inherit; text-decoration: inherit;">Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#influxinstancenode">[]Influx<wbr>Instance<wbr>Node<wbr>Args</a></span>
    </dt>
    <dd><p>Indicates the instance nodes information. Structure is documented below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="influxinstancebackupstrategy">Influx<wbr>Instance<wbr>Backup<wbr>Strategy</h4>
...
<strong>0</strong> to <strong>35</strong>. If this parameter is set to <strong>0</strong>, the automated backup policy is not set. If this parameter is not
transferred, the automated backup policy is enabled by default. Backup files are stored for seven days by default.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="influxinstancedatastore">Influx<wbr>Instance<wbr>Datastore</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#engine_csharp" style="color: inherit; text-decoration: inherit;">Engine</a>
    ...
    <dd><p>Specifies the database engine. Only <strong>influxdb</strong> is supported now.</p>
</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storageengine_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Engine</a>
    ...
    <dd><p>Specifies the storage engine. Only <strong>rocksDB</strong> is supported now.</p>
</dd><dt class="property-required property-replacement"
            title="Required">
...
<h4 id="influxinstancenode">Influx<wbr>Instance<wbr>Node</h4>
