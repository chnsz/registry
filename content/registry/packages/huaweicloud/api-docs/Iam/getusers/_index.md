...
---
title: "getUsers"
title_tag: "huaweicloud.Iam.getUsers"
meta_desc: "Documentation for the huaweicloud.Iam.getUsers function with examples, input properties, output properties, and supporting types."
layout: api
...
{
    var all = Huaweicloud.Iam.GetUsers.Invoke();

    var one = Huaweicloud.Iam.GetUsers.Invoke(new()
    {
        Name = "user_name",
    });
...
import com.pulumi.huaweicloud.Iam.inputs.GetUsersArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var all = IamFunctions.getUsers();

        final var one = IamFunctions.getUsers(GetUsersArgs.builder()
            .name("user_name")
            .build());
...
variables:
  all:
    Fn::Invoke:
      Function: huaweicloud:Iam:getUsers
      Arguments: {}
  one:
    Fn::Invoke:
      Function: huaweicloud:Iam:getUsers
...
><span class="k">def </span>get_users<span class="p">(</span><span class="nx">enabled</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_users_output<span class="p">(</span><span class="nx">enabled</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;Function:</span> huaweicloud:Iam/getUsers:getUsers
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Specifies the status of the IAM user, the default value is <strong>true</strong>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Specifies the IAM user name.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#users_csharp" style="color: inherit; text-decoration: inherit;">Users</a>
    ...
    <dd><p>The details of the queried IAM users. The structure is documented below.</p>
</dd><dt class="property-"
            title="">
        <span id="enabled_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groups_csharp" style="color: inherit; text-decoration: inherit;">Groups</a>
    ...
    <dd><p>Indicates the user groups to which an IAM user belongs.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
