...
---
title: "getFlavors"
title_tag: "huaweicloud.Dds.getFlavors"
meta_desc: "Documentation for the huaweicloud.Dds.getFlavors function with examples, input properties, output properties, and supporting types."
layout: api
...
{
    var flavor = Huaweicloud.Dds.GetFlavors.Invoke(new()
    {
...
import com.pulumi.huaweicloud.Dds.DdsFunctions;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var flavor = DdsFunctions.getFlavors(GetFlavorsArgs.builder()
            .engineName("DDS-Community")
            .vcpus(8)
            .build());
...
variables:
  flavor:
    Fn::Invoke:
      Function: huaweicloud:Dds:getFlavors
      Arguments:
        engineName: DDS-Community
        vcpus: 8
```
...
><span class="k">def </span>get_flavors<span class="p">(</span><span class="nx">engine_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_flavors_output<span class="p">(</span><span class="nx">engine_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;Function:</span> huaweicloud:Dds/getFlavors:getFlavors
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginename_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Name</a>
    ...
    <dd><p>Specifies the engine name of the dds, &quot;DDS-Community&quot; and &quot;DDS-Enhanced&quot; are
supported.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
    ...
    <dd><p>Specifies the ram of the dds flavor in GB.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>Specifies the region in which to obtain the flavors. If omitted,
the provider-level region will be used.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>Specifies the type of the dds falvor. &quot;mongos&quot;, &quot;shard&quot;, &quot;config&quot;, &quot;replica&quot; and &quot;single&quot;
are supported.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
    ...
    <dd><p>Specifies the vcpus of the dds flavor.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
    ...
    <dd><p>See <code>memory</code> above.</p>
</dd><dt class="property-"
            title="">
        <span id="type_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>See <code>type</code> above.</p>
</dd><dt class="property-"
            title="">
        <span id="vcpus_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
    ...
    <dd><p>See <code>vcpus</code> above.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#speccode_csharp" style="color: inherit; text-decoration: inherit;">Spec<wbr>Code</a>
    ...
    <dd><p>The name of the dds flavor.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
