...
---
title: "getFlavors"
title_tag: "huaweicloud.Bms.getFlavors"
meta_desc: "Documentation for the huaweicloud.Bms.getFlavors function with examples, input properties, output properties, and supporting types."
layout: api
...
{
    var demo = Huaweicloud.Bms.GetFlavors.Invoke(new()
    {
    ...
    var instance = new Huaweicloud.Bms.Instance("instance", new()
    {
        FlavorId = demo.Apply(getFlavorsResult => getFlavorsResult.Flavors[0]?.Id),
    });
...
import com.pulumi.huaweicloud.Bms.BmsFunctions;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var demo = BmsFunctions.getFlavors(GetFlavorsArgs.builder()
            .availabilityZone("cn-north-1a")
            .vcpus(48)
            .build());

        var instance = new Instance("instance", InstanceArgs.builder()        
            .flavorId(demo.applyValue(getFlavorsResult -> getFlavorsResult.flavors()[0].id()))
            .build());
...
resources:
  ...
  instance:
    ...
    properties:
      flavorId: ${demo.flavors[0].id}
variables:
  demo:
    Fn::Invoke:
      Function: huaweicloud:Bms:getFlavors
      Arguments:
        availabilityZone: cn-north-1a
        vcpus: 48
```
...
><span class="k">def </span>get_flavors<span class="p">(</span><span class="nx">availability_zone</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">cpu_arch</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
def </span>get_flavors_output<span class="p">(</span><span class="nx">availability_zone</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                <span class="nx">cpu_arch</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;Function:</span> huaweicloud:Bms/getFlavors:getFlavors
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cpuarch_csharp" style="color: inherit; text-decoration: inherit;">Cpu<wbr>Arch</a>
    ...
    <dd><p>Specifies the CPU architecture of the BMS flavor.
The value can be x86_64 and aarch64, defaults to <strong>x86_64</strong>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
    ...
    <dd><p>Specifies the memory size(GB) in the BMS flavor.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
    ...
    <dd><p>Specifies the number of vCPUs in the BMS flavor.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cpuarch_csharp" style="color: inherit; text-decoration: inherit;">Cpu<wbr>Arch</a>
    ...
    <dd><p>The CPU architecture of the BMS flavor.</p>
</dd><dt class="property-"
            title="">
        <span id="memory_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd><p>The id or name of the BMS flavor.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="memory_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#operation_csharp" style="color: inherit; text-decoration: inherit;">Operation</a>
    ...
    <dd><p>The operation status of the BMS flavor in an each AZs.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="vcpus_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
