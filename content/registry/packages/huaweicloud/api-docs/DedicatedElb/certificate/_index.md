...
---
title: "Certificate"
title_tag: "huaweicloud.DedicatedElb.Certificate"
meta_desc: "Documentation for the huaweicloud.DedicatedElb.Certificate resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
{
    var certificate1 = new Huaweicloud.DedicatedElb.Certificate("certificate1", new()
    {
...
import com.pulumi.huaweicloud.DedicatedElb.Certificate;
import com.pulumi.huaweicloud.DedicatedElb.CertificateArgs;
...
resources:
  certificate1:
    type: huaweicloud:DedicatedElb:Certificate
    properties:
      certificate: |+
        -----BEGIN CERTIFICATE-----
        MIIDpTCCAo2gAwIBAgIJAKdmmOBYnFvoMA0GCSqGSIb3DQEBCwUAMGkxCzAJBgNV
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">huaweicloud:DedicatedElb:Certificate</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enterpriseprojectid_csharp" style="color: inherit; text-decoration: inherit;">Enterprise<wbr>Project<wbr>Id</a>
    ...
    <dd><p>The enterprise project id of the certificate.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expiretime_csharp" style="color: inherit; text-decoration: inherit;">Expire<wbr>Time</a>
    ...
    <dd><p>Indicates the expire time.</p>
</dd><dt class="property-"
            title="">
        <span id="id_csharp">
