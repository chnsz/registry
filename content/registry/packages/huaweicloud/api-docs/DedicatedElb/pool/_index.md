...
---
title: "Pool"
title_tag: "huaweicloud.DedicatedElb.Pool"
meta_desc: "Documentation for the huaweicloud.DedicatedElb.Pool resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
{
    var pool1 = new Huaweicloud.DedicatedElb.Pool("pool1", new()
    {
        LbMethod = "ROUND_ROBIN",
        ListenerId = "{{ listener_id }}",
        Persistences = new[]
        {
            new Huaweicloud.DedicatedElb.Inputs.PoolPersistenceArgs
            {
...
import com.pulumi.huaweicloud.DedicatedElb.Pool;
import com.pulumi.huaweicloud.DedicatedElb.PoolArgs;
import com.pulumi.huaweicloud.DedicatedElb.inputs.PoolPersistenceArgs;
...
resources:
  pool1:
    type: huaweicloud:DedicatedElb:Pool
    properties:
      lbMethod: ROUND_ROBIN
      listenerId: '{{ listener_id }}'
      persistences:
...
<span class="k">def </span><span class="nx">Pool</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">persistences</span><span class="p">:</span> <span class="nx">Optional[Sequence[_dedicatedelb.PoolPersistenceArgs]]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">huaweicloud:DedicatedElb:Pool</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
    ...
    <dd><p>The protocol - can either be TCP, UDP, HTTP, HTTPS or QUIC.</p>
...
Changing this creates a new pool. Note:  Exactly one of LoadbalancerID or ListenerID must be provided.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
creates a new pool. Note:  Exactly one of LoadbalancerID or ListenerID must be provided.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">persistences</span><span class="p">:</span> <span class="nx">Optional[Sequence[_dedicatedelb.PoolPersistenceArgs]]</span> = None<span class="p">,</span>
        <span class="nx">protocol</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> Pool</code></pre></div>
</pulumi-choosable>
</div>
