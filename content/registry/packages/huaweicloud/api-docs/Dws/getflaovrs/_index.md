...
---
title: "getFlaovrs"
title_tag: "huaweicloud.Dws.getFlaovrs"
meta_desc: "Documentation for the huaweicloud.Dws.getFlaovrs function with examples, input properties, output properties, and supporting types."
layout: api
...
{
    var flavor = Huaweicloud.Dws.GetFlaovrs.Invoke(new()
    {
        Vcpus = 8,
    });
...
import com.pulumi.huaweicloud.Dws.DwsFunctions;
import com.pulumi.huaweicloud.Dws.inputs.GetFlaovrsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var flavor = DwsFunctions.getFlaovrs(GetFlaovrsArgs.builder()
            .vcpus(8)
            .build());
...
variables:
  flavor:
    Fn::Invoke:
      Function: huaweicloud:Dws:getFlaovrs
      Arguments:
        vcpus: 8
```
...
><span class="k">function </span>getFlaovrs<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetFlaovrsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetFlaovrsResult</a></span>></span
><span class="k">
function </span>getFlaovrsOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetFlaovrsOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetFlaovrsResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_flaovrs<span class="p">(</span><span class="nx">availability_zone</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                ...
                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetFlaovrsResult</span
><span class="k">
def </span>get_flaovrs_output<span class="p">(</span><span class="nx">availability_zone</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                ...
                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetFlaovrsResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>GetFlaovrs<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetFlaovrsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetFlaovrsResult</a></span>, error)</span
><span class="k">
func </span>GetFlaovrsOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetFlaovrsOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetFlaovrsResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetFlaovrs` in the Go SDK.
...
<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetFlaovrs </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetFlaovrsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetFlaovrsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetFlaovrsResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetFlaovrsInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetFlaovrsResult</a></span>> </span>getFlaovrs<span class="p">(</span><span class="nx">GetFlaovrsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
...
<span class="k">&nbsp;&nbsp;Function:</span> huaweicloud:Dws/getFlaovrs:getFlaovrs
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzone_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone</a>
    ...
    <dd><p>Specifies the availability zone name.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
    ...
    <dd><p>Specifies the ram of the dws node flavor in GB.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>Specifies the region in which to obtain the dws cluster client. If omitted, the
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
    ...
    <dd><p>Specifies the vcpus of the dws node flavor.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#flavors_csharp" style="color: inherit; text-decoration: inherit;">Flavors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getflaovrsflavor">List&lt;Get<wbr>Flaovrs<wbr>Flavor&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
    ...
    <dd><p>Indicates the ram of the dws node flavor in GB.</p>
</dd><dt class="property-"
            title="">
        <span id="vcpus_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
    ...
    <dd><p>Indicates the vcpus of the dws node flavor.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#flavors_go" style="color: inherit; text-decoration: inherit;">Flavors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getflaovrsflavor">[]Get<wbr>Flaovrs<wbr>Flavor</a></span>
    </dt>
    <dd><p>Indicates the flavors information. Structure is documented below.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#flavors_yaml" style="color: inherit; text-decoration: inherit;">flavors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getflaovrsflavor">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>Indicates the flavors information. Structure is documented below.</p>
</dd><dt class="property-"
            title="">
...
<h4 id="getflaovrsflavor">Get<wbr>Flaovrs<wbr>Flavor</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#flavorid_csharp" style="color: inherit; text-decoration: inherit;">Flavor<wbr>Id</a>
    ...
    <dd><p>The name of the dws node flavor. It is referenced by <code>node_type</code> in <code>huaweicloud.Dws.getFlaovrs</code>.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="memory_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd><p>Indicates the Disk size in GB.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="vcpus_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vcpus_csharp" style="color: inherit; text-decoration: inherit;">Vcpus</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#volumetype_csharp" style="color: inherit; text-decoration: inherit;">Volumetype</a>
    ...
    <dd><p>Indicates Disk type.</p>
<ul>
<li><strong>LOCAL_DISK</strong>: common I/O disk</li>
<li><strong>SSD</strong>: ultra-high I/O disk</li>
</ul>
</dd></dl>
</pulumi-choosable>
</div>
