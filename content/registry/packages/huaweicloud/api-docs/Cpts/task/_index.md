...
---
title: "Task"
title_tag: "huaweicloud.Cpts.Task"
meta_desc: "Documentation for the huaweicloud.Cpts.Task resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
{
    var testProject = new Huaweicloud.Cpts.Project("testProject");

    var testTask = new Huaweicloud.Cpts.Task("testTask", new()
    {
...
import com.pulumi.huaweicloud.Cpts.Task;
import com.pulumi.huaweicloud.Cpts.TaskArgs;
...
<span class="k">def </span><span class="nx">Task</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">benchmark_concurrency</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">huaweicloud:Cpts:Task</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#projectid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Id</a>
    ...
    <dd><p>Specifies the CPTS project ID which the task belongs to.
Changing this parameter will create a new resource.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="benchmarkconcurrency_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#benchmarkconcurrency_csharp" style="color: inherit; text-decoration: inherit;">Benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd><p>Specifies benchmark concurrency of the task, the value range is 0 to
2000000. The default value is <code>100</code>. Reference for the calculation of the number of concurrent users.
<code>Number of concurrent users</code> = <code>benchmark concurrency</code> * <code>concurrency ratio</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterid_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Id</a>
    ...
    <dd><p>Specifies a cluster ID of the CPTS resource group. If the number of concurrent users
is less than 1000, you can use a shared resource group for testing and do not have to create a resource group.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Specifies the name of the task, which can contain a maximum of 42 characters.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#operation_csharp" style="color: inherit; text-decoration: inherit;">Operation</a>
    ...
    <dd><p>Specifies whether to enable the task or stop the task. The options are as follows:</p>
<ul>
<li><strong>enable</strong>: Starting the pressure test task.</li>
<li><strong>stop</strong>: Stop the pressure test tasks.</li>
</ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>Specifies the region in which to create the task resource. If omitted, the
...
Changing this parameter will create a new resource.</p>
            ...
            title="Optional">
        <span id="benchmarkconcurrency_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#benchmarkconcurrency_go" style="color: inherit; text-decoration: inherit;">Benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
Changing this parameter will create a new resource.</p>
            ...
            title="Optional">
        <span id="benchmarkconcurrency_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#benchmarkconcurrency_java" style="color: inherit; text-decoration: inherit;">benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
Changing this parameter will create a new resource.</p>
            ...
            title="Optional">
        <span id="benchmarkconcurrency_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#benchmarkconcurrency_nodejs" style="color: inherit; text-decoration: inherit;">benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
Changing this parameter will create a new resource.</p>
            ...
            title="Optional">
        <span id="benchmark_concurrency_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#benchmark_concurrency_python" style="color: inherit; text-decoration: inherit;">benchmark_<wbr>concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
Changing this parameter will create a new resource.</p>
            ...
            title="Optional">
        <span id="benchmarkconcurrency_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#benchmarkconcurrency_yaml" style="color: inherit; text-decoration: inherit;">benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd><p>The status of the task. The options are as follows:</p>
<ul>
<li><strong>0</strong>: The task is running.</li>
<li><strong>2</strong>: The task is idle.</li>
</ul>
</dd></dl>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">project_id</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">) -&gt;</span> Task</code></pre></div>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_benchmarkconcurrency_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_benchmarkconcurrency_csharp" style="color: inherit; text-decoration: inherit;">Benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_benchmarkconcurrency_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_benchmarkconcurrency_go" style="color: inherit; text-decoration: inherit;">Benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_benchmarkconcurrency_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_benchmarkconcurrency_java" style="color: inherit; text-decoration: inherit;">benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_benchmarkconcurrency_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_benchmarkconcurrency_nodejs" style="color: inherit; text-decoration: inherit;">benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_benchmark_concurrency_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_benchmark_concurrency_python" style="color: inherit; text-decoration: inherit;">benchmark_<wbr>concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_benchmarkconcurrency_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_benchmarkconcurrency_yaml" style="color: inherit; text-decoration: inherit;">benchmark<wbr>Concurrency</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
