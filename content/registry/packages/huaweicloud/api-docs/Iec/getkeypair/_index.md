...
---
title: "getKeypair"
title_tag: "huaweicloud.Iec.getKeypair"
meta_desc: "Documentation for the huaweicloud.Iec.getKeypair function with examples, input properties, output properties, and supporting types."
layout: api
...
{
    var kp1 = Huaweicloud.Iec.GetKeypair.Invoke(new()
    {
...
import com.pulumi.huaweicloud.Iec.inputs.GetKeypairArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var kp1 = IecFunctions.getKeypair(GetKeypairArgs.builder()
            .name("iec-keypair-demo")
            .build());
...
variables:
  kp1:
    Fn::Invoke:
      Function: huaweicloud:Iec:getKeypair
      Arguments:
        name: iec-keypair-demo
```
...
><span class="k">def </span>get_keypair<span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_keypair_output<span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
><span class="k">func </span>GetKeypair<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetKeypairArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetKeypairResult</a></span>, error)</span
><span class="k">
func </span>GetKeypairOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetKeypairOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetKeypairResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetKeypair` in the Go SDK.
...
<span class="k">&nbsp;&nbsp;Function:</span> huaweicloud:Iec/getKeypair:getKeypair
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Specifies a unique name for the keypair. This parameter can contain a maximum of 64
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publickey_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Key</a>
    ...
    <dd><p>The pregenerated OpenSSH-formatted public key.</p>
</dd></dl>
</pulumi-choosable>
</div>
