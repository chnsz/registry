...
---
title: "Vpc"
title_tag: "huaweicloud.Iec.Vpc"
meta_desc: "Documentation for the huaweicloud.Iec.Vpc resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
return await Deployment.RunAsync(() => 
{
    ...
    var vpc = new Huaweicloud.Iec.Vpc("vpc", new()
    {
        Cidr = vpcCidr,
    });

    var vpcByCustomer = new Huaweicloud.Iec.Vpc("vpcByCustomer", new()
    {
        Cidr = vpcCidr,
        Mode = "CUSTOMER",
    });
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        var vpcByCustomer = new Vpc("vpcByCustomer", VpcArgs.builder()        
            .cidr(vpcCidr)
            .mode("CUSTOMER")
            .build());
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">huaweicloud:Iec:Vpc</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cidr_csharp" style="color: inherit; text-decoration: inherit;">Cidr</a>
    ...
    <dd><p>Specifies the IP address range for the VPC. The subnet IP address in the VPC must be
within the IP address range of the VPC. The following CIDR blocks are supported:
<em>10.0.0.0/8-16</em>, <em>172.16.0.0/12-16</em>, <em>192.168.0.0/16</em>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd><p>Specifies the mode of the IEC VPC. Possible values are &quot;SYSTEM&quot; and &quot;CUSTOMER&quot;,
defaults to &quot;SYSTEM&quot;. Changing this creates a new IEC VPC.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd><p>The region in which to create the IEC VPC. If omitted, the provider-level
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">subnet_num</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">) -&gt;</span> Vpc</code></pre></div>
</pulumi-choosable>
</div>
...
region will be used. Changing this creates a new resource.</p>
            ...
            title="Optional">
        <span id="state_subnetnum_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnetnum_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Num</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
region will be used. Changing this creates a new resource.</p>
            ...
            title="Optional">
        <span id="state_subnetnum_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnetnum_go" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Num</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
region will be used. Changing this creates a new resource.</p>
            ...
            title="Optional">
        <span id="state_subnetnum_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnetnum_java" style="color: inherit; text-decoration: inherit;">subnet<wbr>Num</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
region will be used. Changing this creates a new resource.</p>
            ...
            title="Optional">
        <span id="state_subnetnum_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnetnum_nodejs" style="color: inherit; text-decoration: inherit;">subnet<wbr>Num</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
region will be used. Changing this creates a new resource.</p>
            ...
            title="Optional">
        <span id="state_subnet_num_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnet_num_python" style="color: inherit; text-decoration: inherit;">subnet_<wbr>num</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
region will be used. Changing this creates a new resource.</p>
            ...
            title="Optional">
        <span id="state_subnetnum_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnetnum_yaml" style="color: inherit; text-decoration: inherit;">subnet<wbr>Num</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
